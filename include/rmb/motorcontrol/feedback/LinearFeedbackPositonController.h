...
#include "rmb/motorcontrol/feedback/AngularFeedbackPositonController.h"
...
public:
   ...
   */
  LinearAsAngularPositionFeedbackController asLinearEncoder(ConversionUnit_t conversion) {
    return LinearAsAngularPositionFeedbackController(*this, conversion);
  }
};

class LinearAsAngularPositionFeedbackController : public AngularFeedbackPositionController {
public:

  using ConversionUnit = units::compound_unit<units::meters, units::inverse<units::radians>>;
  using ConversionUnit_t = units::unit_t<ConversionUnit>;

  LinearAsAngularPositionFeedbackController(const LinearAsAngularPositionFeedbackController&) = delete;
  LinearAsAngularPositionFeedbackController(LinearAsAngularPositionFeedbackController&&) = default;

  LinearAsAngularPositionFeedbackController(LinearFeedbackPositionController& linearController, 
...
private:
  LinearFeedbackPositionController& linear;
