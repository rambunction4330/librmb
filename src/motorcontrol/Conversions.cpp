...
asLinear(std::unique_ptr<AngularVelocityController> angularController,
  ...
  return std::make_unique<AngularAsLinearVelocityController>(angularController,
                                                             conversion);
}
...
asLinear(std::unique_ptr<AngularPositionController> angularController,
         MotorControlConversions::ConversionUnit_t conversion) {
  return std::make_unique<AngularAsLinearPositionController>(angularController,
                                                             conversion);
}
...
asAngular(std::unique_ptr<LinearVelocityController> linearController,
          MotorControlConversions::ConversionUnit_t conversion) {
  return std::make_unique<LinearAsAngularVelocityController>(linearController,
                                                             conversion);
}
...
asAngular(std::unique_ptr<LinearPositionController> linearController,
          MotorControlConversions::ConversionUnit_t conversion) {
  return std::make_unique<LinearAsAngularPositionController>(linearController,
                                                             conversion);
}
