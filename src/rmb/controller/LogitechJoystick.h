...
public:
  ...
  LogitechJoystick(int channel, double deadZone = 0.0,
  ...
  frc2::Trigger XLessThan(double threshold) const {
    return AxisLessThan(Axes::X, threshold);
  }
  frc2::Trigger XMoreThan(double threshold) const {
    return AxisGreaterThan(Axes::X, threshold);
  }
  ...
  frc2::Trigger YMoreThan(double threshold) const {
    return AxisGreaterThan(Axes::Y, threshold);
  }
  ...
  frc2::Trigger TwistLessThan(double threshold) const {
    return AxisLessThan(Axes::twist, threshold);
  }
  frc2::Trigger TwistMoreThan(double threshold) const {
    return AxisGreaterThan(Axes::twist, threshold);
  }
  ...
  frc2::Trigger ThrottleLessThan(double threshold) const {
    return AxisLessThan(Axes::throttle, threshold);
  }
  frc2::Trigger ThrottleMoreThan(double threshold) const {
    return AxisGreaterThan(Axes::throttle, threshold);
  }
