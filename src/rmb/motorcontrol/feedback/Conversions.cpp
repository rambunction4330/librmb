...
public:
  AngularAsLinearEncoder(
      std::shared_ptr<AngularEncoder> angularEncoder,
...
std::shared_ptr<LinearEncoder>
asLinear(std::shared_ptr<AngularEncoder> angularEncoder,
         MotorControlConversions::ConversionUnit_t conversion) {
...
public:
  AngularAsLinearVelocityFeedbackController(
      std::shared_ptr<AngularVelocityFeedbackController> angularController,
      MotorControlConversions::ConversionUnit_t conversionFactor)
  ...
  // Feedback Methods
  units::meters_per_second_t getTolerance() const {
...
std::shared_ptr<LinearVelocityFeedbackController>
asLinear(std::shared_ptr<AngularVelocityFeedbackController> angularController,
         MotorControlConversions::ConversionUnit_t conversion) {
  return std::make_shared<AngularAsLinearVelocityFeedbackController>(
...
public:
  AngularAsLinearPositionFeedbackController(
      std::shared_ptr<AngularPositionFeedbackController> angularController,
      MotorControlConversions::ConversionUnit_t conversionFactor)
      : angular(angularController), conversion(conversionFactor) {}
  ...
  // Feedback Methods
  units::meter_t getTolerance() const {
    return angular->getTolerance() * conversion;
  }
...
asLinear(std::shared_ptr<AngularPositionFeedbackController> angularController,
         MotorControlConversions::ConversionUnit_t conversion) {
  return std::make_shared<AngularAsLinearPositionFeedbackController>(
      angularController, conversion);
}
...
public:
  LinearAsAngularEncoder(
      std::shared_ptr<LinearEncoder> linearEncoder,
      MotorControlConversions::ConversionUnit_t conversionFactor)
...
std::shared_ptr<AngularEncoder>
asAngular(std::shared_ptr<LinearEncoder> linearEncoder,
          MotorControlConversions::ConversionUnit_t conversion) {
...
public:
  LinearAsAngularVelocityFeedbackController(
      std::shared_ptr<LinearVelocityFeedbackController> linearController,
      MotorControlConversions::ConversionUnit_t conversionFactor)
  ...
  // Feedback Methods
  units::radians_per_second_t getTolerance() const {
...
std::shared_ptr<AngularVelocityFeedbackController>
asAngular(std::shared_ptr<LinearVelocityFeedbackController> linearController,
          MotorControlConversions::ConversionUnit_t conversion) {
  return std::make_shared<LinearAsAngularVelocityFeedbackController>(
...
public:
  LinearAsAngularPositionFeedbackController(
      std::shared_ptr<LinearPositionFeedbackController> linearController,
      MotorControlConversions::ConversionUnit_t conversionFactor)
      : linear(linearController), conversion(conversionFactor) {}
...
std::shared_ptr<AngularPositionFeedbackController>
asAngular(std::shared_ptr<LinearPositionFeedbackController> linearController,
          MotorControlConversions::ConversionUnit_t conversion) {
  return std::make_shared<LinearAsAngularPositionFeedbackController>(
      linearController, conversion);
}
} // namespace rmb