...
public:
   ...
   */
  void setMaxVelocity(units::meters_per_second_t max) { maxVelocity = max; }
   ...
   */
  units::meters_per_second_t getMaxVelocity() const { return maxVelocity; }
